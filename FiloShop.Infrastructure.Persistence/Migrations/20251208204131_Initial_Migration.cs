    ...
    public partial class Initial_Migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdempotencyRecord", x => x.IdempotencyKey);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogItemOrdered_CatalogItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    CatalogItemOrdered_PictureUrl = table.Column<string>(type: "text", nullable: true),
                    CatalogItemOrdered_ProductName = table.Column<string>(type: "text", nullable: false),
                    UnitPrice_Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    UnitPrice_Currency = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentMethod", x => new { x.UserId, x.Id });
                    table.ForeignKey(
